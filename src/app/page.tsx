      ...
      <div className="mt-10 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mt-4 text-zinc-600">
            Saya memiliki pengalaman dalam mengembangkan aplikasi berbasis Laravel, Next.js, untuk berbagai proyek, termasuk sistem inventaris dan reservasi lapangan sport center.
          </p>
